...
public class MenuViewServices {
	...
	public List<ItemCategoryDTO> getAllItemsForRestaraunt(String restarauntSid) throws ApplicationException{
		...
		List<ItemCategoryDTO> itemsDTO=commonRepoServ.getDtoListByNamedQuery(ItemCategory.class, ItemCategoryDTO.class, ItemCategory.FIND_BY_RESTRO_SID, QueryParameter.with("sid", restarauntSid).parameters());
		return itemsDTO;
	}
